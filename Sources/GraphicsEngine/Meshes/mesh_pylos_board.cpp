...
MeshPylosBoard::MeshPylosBoard(int levelCount)
{
    m_levelCount = (levelCount < 1) ? 1 : levelCount;
}

void MeshPylosBoard::Init()
{
    Mesh::Init();
...
void MeshPylosBoard::Deinit()
{
    Mesh::Deinit();
}

void MeshPylosBoard::InitCubeSimple()
{
...
void MeshPylosBoard::InitCubeDetailedStrip()
{
...
void MeshPylosBoard::InitCubeDetailedList()
{
