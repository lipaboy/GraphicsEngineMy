...
DX11PixelShader::DX11PixelShader(const char * fileName)
{
	...
	m_pImmediateContext	= pContextDX11->m_pImmediateContext;
	...
	m_constantBuffer.Init(m_pDevice, m_pImmediateContext, false);
...
{
	const DX11Texture2D * pDX11Texture = static_cast<const DX11Texture2D *>(pTexture->GetImplPointer());
